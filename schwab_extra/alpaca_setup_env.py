...
VARS = {
    "alpaca_live_endpoint": {
        "desc": "Your Alpaca Live endpoint (HTTPS://...)",
        "validator": lambda v: bool(urlparse(v).scheme in ("https") and urlparse(v).netloc),
        "error": "Must be HTTPS:// + alphanumeric and at least 10 characters.",
    },
    "alpaca_live_api_key": {
        "desc": "Your Alpaca live API KEY (alphanumeric)",
        "validator": lambda v: v.isalnum() and len(v) >= 10,
        "error": "Must be alphanumeric and at least 10 characters.",
    },
    "alpaca_live_secret": {
        "desc": "Your Alpaca Live App Secret (alphanumeric)",
        "validator": lambda v: v.isalnum() and len(v) >= 10,
        "error": "Must be alphanumeric and at least 10 characters.",
    },
    "alpaca_paper_endpoint": {
        "desc": "Your Alpaca Paper endpoint (HTTPS://...)",
        "validator": lambda v: bool(urlparse(v).scheme in ("https") and urlparse(v).netloc),
        "error": "Must be HTTPS:// + alphanumeric and at least 10 characters.",
    },
    "alpaca_paper_api_key": {
        "desc": "Your Alpaca Paper API KEY (alphanumeric)",
        "validator": lambda v: v.isalnum() and len(v) >= 10,
        "error": "Must be alphanumeric and at least 10 characters.",
    },
    "alpaca_paper_secret": {
        "desc": "Your Alpaca Paper App Secret (alphanumeric)",
        "validator": lambda v: v.isalnum() and len(v) >= 10,
        "error": "Must be alphanumeric and at least 10 characters.",
    },
...
def display_vars():
    print("Current Alpaca environment variables:")
    for name in VARS:
...
def main():
    parser = argparse.ArgumentParser(
        description="Manage Alpaca environment variables (Windows & Linux)"
    )
    parser.add_argument(
